...
import wtf.alexis.licorice.events.EventKeyPress;
import wtf.alexis.licorice.events.EventStart;
import wtf.alexis.licorice.hooks.HGuiIngame;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void run()
    {
        ...
        {
            this.startGame();
            Licorice.eventBus().post(new EventStart());
            //session = new Session("<email>".trim(), "p", "p", "p");
        }
    ...
    private void startGame() throws LWJGLException
    {
        ...
        this.ingameGUI = new HGuiIngame(this);
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        Licorice.eventBus().post(new EventKeyPress());
